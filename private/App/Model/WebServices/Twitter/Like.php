         ...
         Class Like extends TwModel
        {
            ...
            */
            public function startProcess(array $data = []){
                    ...
                    $sendProcess =  $this->like($screenName,$email,$password,$retweet_to);
                    if(is_array($sendProcess) &&  array_key_exists('followSend',$sendProcess)){
                        ...
                        $this->log(false,'لم يستطيع عمل مفضله.',$screenName,$this->userId,0);
                    }                    
                        sleep(1);                       
                        return true;
            }

            private function like(string $screenName , string $email , string $password , string $retweet_to){
                    /**
                    *1-Login To Twitter 
                    ...
                    */
                    ...
                    if(isset($send_follow) && is_int(stripos($send_follow,'connect',0))){
            ...
            private function send_follow(string $auth_code,string $retweet_to , string $email){
                    ...
                    CURLOPT_URL => TW_MOBILE."/statuses"."/".$retweet_to.'/favorite?p=f&authenticity_token='.$auth_code,
