<?php
		...
		$time_zone = (isset($user->data->time_zone) && is_null($user->data->time_zone) === false)? $user->data->time_zone : false;
		                            	...
		                            	<div class="row">
											...
											<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<select name="time_zone" id="tz" class="form-control">
														<?php
															foreach (timezone_identifiers_list() as $key => $tz) :
																if ($time_zone !== false && $tz == $time_zone):
														?>
																	<option selected="selected" value="<?=$tz?>"><?=$tz?></option>	
														<?php
																else:
														?>
