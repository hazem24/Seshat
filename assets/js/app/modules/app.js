var BASE_URI = "/seshat/", BASE_URL = "http://127.0.0.1/seshat/", template_url = BASE_URL + "assets/js/app/modules/";
css_url = BASE_URL + "assets/css/";
var app = angular.module('seshatApp', [
    'ngJsonExportExcel',
    "ngRoute"
]).controller("appCtrl", function ($scope, $sce, $window, AppServices) {
...
app.config(function ($routeProvider) {
    $routeProvider.when("/controlfollowers/recentFollowers", {
